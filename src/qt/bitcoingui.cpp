                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SecureCloud Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SCN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and securecloud: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SecureCloud Core"), this);
    aboutAction->setStatusTip(tr("Show information about SecureCloud Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SecureCloud"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SCN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SCN addresses"));
    ...
    openAction->setStatusTip(tr("Open a securecloud: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SecureCloud Core help message to get a list with possible SecureCloud command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SecureCloud Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SecureCloud network", "", count));
}
...
{
    QString strTitle = tr("SecureCloud Core"); // default title
