...
// SCN: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_19_NEW_PROTOCOL_ENFORCEMENT_5   ) r = SPORK_19_NEW_PROTOCOL_ENFORCEMENT_5_DEFAULT;
        if (nSporkID == SPORK_20_NEW_PROTOCOL_ENFORCEMENT_6   ) r = SPORK_20_NEW_PROTOCOL_ENFORCEMENT_6_DEFAULT;
        if (nSporkID == SPORK_21_NEW_PROTOCOL_ENFORCEMENT_7   ) r = SPORK_21_NEW_PROTOCOL_ENFORCEMENT_7_DEFAULT;
        if (nSporkID == SPORK_22_NEW_PROTOCOL_ENFORCEMENT_8   ) r = SPORK_22_NEW_PROTOCOL_ENFORCEMENT_8_DEFAULT;
        if (nSporkID == SPORK_23_NEW_PROTOCOL_ENFORCEMENT_9   ) r = SPORK_23_NEW_PROTOCOL_ENFORCEMENT_9_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_19_NEW_PROTOCOL_ENFORCEMENT_5"   ) return SPORK_19_NEW_PROTOCOL_ENFORCEMENT_5;
    if (strName == "SPORK_20_NEW_PROTOCOL_ENFORCEMENT_6"   ) return SPORK_20_NEW_PROTOCOL_ENFORCEMENT_6;
    if (strName == "SPORK_21_NEW_PROTOCOL_ENFORCEMENT_7"   ) return SPORK_21_NEW_PROTOCOL_ENFORCEMENT_7;
    if (strName == "SPORK_22_NEW_PROTOCOL_ENFORCEMENT_8"   ) return SPORK_22_NEW_PROTOCOL_ENFORCEMENT_8;
    if (strName == "SPORK_23_NEW_PROTOCOL_ENFORCEMENT_9"   ) return SPORK_23_NEW_PROTOCOL_ENFORCEMENT_9;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_19_NEW_PROTOCOL_ENFORCEMENT_5   ) return "SPORK_19_NEW_PROTOCOL_ENFORCEMENT_5";
    if (id == SPORK_20_NEW_PROTOCOL_ENFORCEMENT_6   ) return "SPORK_20_NEW_PROTOCOL_ENFORCEMENT_6";
    if (id == SPORK_21_NEW_PROTOCOL_ENFORCEMENT_7   ) return "SPORK_21_NEW_PROTOCOL_ENFORCEMENT_7";
    if (id == SPORK_22_NEW_PROTOCOL_ENFORCEMENT_8   ) return "SPORK_22_NEW_PROTOCOL_ENFORCEMENT_8";
    if (id == SPORK_23_NEW_PROTOCOL_ENFORCEMENT_9   ) return "SPORK_23_NEW_PROTOCOL_ENFORCEMENT_9";
