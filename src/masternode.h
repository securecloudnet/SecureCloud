...
#define MASTERNODE_COLLATERAL 1200
#define MASTERNODE_COLLATERAL_AFTER_241800 10000
...
//
// The Masternode Class. It contains the input of the SCN collateral, signature to prove
